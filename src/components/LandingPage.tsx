...
export function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-7xl mx-auto p-6 space-y-16">
        ...
        <div className="text-center space-y-8 py-16">
          <div className="flex justify-center">
            <div className="w-20 h-20 bg-gradient-to-br from-primary to-primary/90 rounded-3xl flex items-center justify-center shadow-lg">
          ...
          <div className="flex items-center justify-center space-x-12 text-sm">
            <div className="flex items-center space-x-3">
              ...
              <span className="font-medium">13 Core Features</span>
            </div>
            <div className="flex items-center space-x-3">
              <div className="w-3 h-3 bg-blue-500 rounded-full animate-pulse"></div>
              <span className="font-medium">54 API Endpoints</span>
            </div>
            <div className="flex items-center space-x-3">
            ...
            <div className="flex items-center space-x-3">
              ...
              <span className="font-medium">14 Data Entities</span>
            </div>
          </div>
          ...
          <div className="pt-8">
            <Button 
              ...
              className="text-lg px-10 py-4 h-auto shadow-lg hover:shadow-xl transition-all duration-300 bg-accent hover:bg-accent/90 text-white"
            >
        ...
        <Tabs defaultValue="features" className="w-full">
          <TabsList className="grid w-full grid-cols-4 h-12">
            ...
            <TabsTrigger value="architecture" className="text-base">Architecture</TabsTrigger>
            <TabsTrigger value="data-model" className="text-base">Data Model</TabsTrigger>
            <TabsTrigger value="ui-overview" className="text-base">UI Overview</TabsTrigger>
          </TabsList>

          {/* Features Tab */}
          <TabsContent value="features" className="space-y-12">
            <div className="text-center space-y-6">
              <h2 className="text-4xl font-bold text-primary">Platform Features</h2>
          ...
          <TabsContent value="architecture" className="space-y-12">
            ...
            <Card className="shadow-lg">
              <CardHeader>
                <CardTitle className="text-2xl text-primary">Architecture Diagram</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="flex justify-center">
                  <div className="w-full max-w-4xl h-96 bg-gray-100 rounded-lg border-2 border-dashed border-gray-300 flex items-center justify-center">
                    <div className="text-center">
                      <Heart className="w-12 h-12 text-primary/40 mx-auto mb-4" />
                      <p className="text-gray-500 text-lg">Architecture Diagram</p>
                      <p className="text-gray-400 text-sm">Will be updated with actual diagram</p>
                    </div>
                  </div>
                </div>
              </CardContent>
          ...
          {/* Data Model Tab */}
          <TabsContent value="data-model" className="space-y-12">
            <div className="text-center space-y-6">
              <h2 className="text-4xl font-bold text-primary">Data Model Overview</h2>
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            ...
            <Card className="shadow-lg">
              <CardHeader>
                <CardTitle className="text-2xl text-primary">Core Entities</CardTitle>
              </CardHeader>
              <CardContent>
                <Table>
                  <TableHeader>
                    <TableRow>
                      <TableHead className="text-lg text-primary">Entity</TableHead>
                      <TableHead className="text-lg text-primary">Key Fields</TableHead>
                      <TableHead className="text-lg text-primary">Relationships</TableHead>
                      <TableHead className="text-lg text-primary">Description</TableHead>
                    </TableRow>
                  </TableHeader>
                  <TableBody>
          ...
          {/* UI Overview Tab */}
          <TabsContent value="ui-overview" className="space-y-12">
            <div className="text-center space-y-6">
              <h2 className="text-4xl font-bold text-primary">User Interface Overview</h2>
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
      ...
      {/* Footer */}
      <footer className="bg-gradient-to-r from-primary to-primary/90 text-primary-foreground py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="flex items-center justify-center space-x-3 mb-4">
              ...
              <span className="text-xl font-bold">HealthCare API</span>
            </div>
